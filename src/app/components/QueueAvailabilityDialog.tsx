...
interface QueueAvailabilityDialogProps {
  children: React.ReactNode;
}

// Admin-only config dialog for the print-queue submission window, opened from
// a button on the Queue page. Restricts the public /request form to a
// configurable time window instead of accepting submissions around the clock.
export function QueueAvailabilityDialog({ children }: QueueAvailabilityDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-lg">
        <DialogHeader>
          <DialogTitle>Queue Availability</DialogTitle>
          <DialogDescription>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between gap-4">
            <Label htmlFor="queue-availability-toggle">Enabled</Label>
            <Switch
